...
- ID は `term_Ab3xYz9Qw2` のように「プレフィクス + 英数字10文字」で、プレフィクスが種類を示す: `term_`＝用語／`error_`＝エラー／`actor_`＝シーケンスの参加者／`step_`＝シーケンスのステップ／`node_`＝ロジックツリーのノード／`issue_`＝課題ツリーの課題／`hypothesis_`＝課題ツリーの仮説
